...
- Modify: `docs/architecture/控制中心状态与历史-设计.md`
...
运行：`git add docs/architecture/v2-UI信息架构.md docs/product/v1/v1-产品契约.md docs/architecture/控制中心状态与历史-设计.md && git commit -m "docs: record control center history behavior"`。

...
- `docs/plans/v1/v1-优化路线图.md`
- `docs/plans/v2/安装连通性-实施计划.md`
...
- `docs/operations/端到端检查清单.md` (修改)
- `docs/operations/排障手册.md` (修改)
...
3. 阅读 `P6` 方向文档：
   ...
   ```bash
   sed -n '136,155p' docs/plans/v1/v1-优化路线图.md
   ```
...
- 项目文档继续保持中文优先。
- `P4` 前不回退已完成的 `P3` 安装链路。
- 审核仍以 `docs/product/v1/v1-产品契约.md` 为最高项目契约。

...
- 三指快速左轻扫，切换到当前 Chrome 窗口左侧标签页。
- 三指快速右轻扫，切换到当前 Chrome 窗口右侧标签页。
...
- 当前标签页不得跳转到被三指点按的链接。
- 三指点按未命中链接时，触控板左半区切左侧标签页，右半区切右侧标签页。
- 三指双击空白处关闭当前标签页；双击窗口内第一下不得先触发半区切 tab。
- 三指快速左轻扫能切到同一 Chrome 窗口左侧标签页。
- 三指快速右轻扫能切到同一 Chrome 窗口右侧标签页。
- 到达最左或最右标签页时在当前窗口内循环切换：最左左滑到最后一个标签页，最右右滑到第一个标签页。
- 在无链接位置三指点按不会误打开页面。
...
- 至少完成一次手动端到端验证：三指点按链接、三指快速左轻扫、三指快速右轻扫。
